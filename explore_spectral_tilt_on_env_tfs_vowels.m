...
AllChinIDs= 370; %[358 360 366 367 369 370];% [366 369];
...
%             postFix= 'NH';
    ...
    subplot(211);
    hold on
    lg_hans(1)= plot(t_sig, -A_shift + A_stim*sig, 'color', co(1,:)); % very first time
    ...
    lg_hans(2)= plot(t_data, A_shift + s_data_env, 'color', co(4,:)); % very first time
    lg_hans(3)= plot(t_data, s_data_tfs, 'color', co(5,:)); % very first time
